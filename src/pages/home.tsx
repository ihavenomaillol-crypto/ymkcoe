...
Indrayani Vidya Mandir.`,
  },
  {
    ...
    organization: "Indrayani Vidya Mandir",
    image: "/director.jpg",
    preview: "\"Welcome to Indrayani Vidya Mandir. Our institution is committed to providing quality technical education that empowers students — especially those from economically weaker sections — to become confident professionals in today's competitive world...\"",
...
export default function Home() {
  ...
  return (
    <AppLayout>
      {/* Hero Section */}
      <section data-scroll-reveal className="relative w-full h-[600px] md:h-[700px] flex items-center bg-primary overflow-hidden">
