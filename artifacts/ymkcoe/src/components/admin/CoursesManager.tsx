                    ...
                    <FormItem>
                      ...
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="Mechanical Engg">Mechanical Engg</SelectItem>
                          <SelectItem value="Civil Engg">Civil Engg</SelectItem>
                          <SelectItem value="Electronics & Telecom">E&TC</SelectItem>
                          <SelectItem value="Electrical Engg">Electrical Engg</SelectItem>
                        </SelectContent>
                      </Select>
                      <FormMessage/>
                    </FormItem>
