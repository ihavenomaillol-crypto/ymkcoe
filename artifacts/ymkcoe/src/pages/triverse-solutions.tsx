...
export default function TriverseSolutions() {
  return (
    <div className="min-h-screen bg-[#fafafc] font-sans selection:bg-purple-200">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden lg:flex space-x-6 text-sm font-medium text-slate-600">
              ...
              <a href="#about" className="hover:text-purple-600 transition-colors">Team</a>
            </div>
      ...
      {/* Vision & Mission */}
      <section id="overview" className="py-20 bg-white border-y border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12">
            <div className="p-8 rounded-3xl bg-gradient-to-br from-purple-50 to-white border border-purple-100 relative overflow-hidden">
              <div className="absolute top-0 right-0 p-8 opacity-10">
                <Globe2 className="w-32 h-32 text-purple-600" />
              </div>
              <h3 className="text-2xl font-bold text-slate-900 mb-4 flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-purple-100 flex items-center justify-center text-purple-600"><Globe2 className="w-5 h-5" /></div>
                Our Vision
              </h3>
            ...
            <div className="p-8 rounded-3xl bg-gradient-to-br from-fuchsia-50 to-white border border-fuchsia-100 relative overflow-hidden">
              <div className="absolute top-0 right-0 p-8 opacity-10">
                <Target className="w-32 h-32 text-fuchsia-600" />
              </div>
              <h3 className="text-2xl font-bold text-slate-900 mb-4 flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-fuchsia-100 flex items-center justify-center text-fuchsia-600"><Target className="w-5 h-5" /></div>
                Our Mission
              </h3>
              <p className="text-slate-600 text-lg leading-relaxed relative z-10">
      ...
      <section id="services" className="py-24 bg-[#fafafc]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Comprehensive Capabilities</h2>
          ...
          <div className="space-y-16">
            ...
            <div>
              <h3 className="text-2xl font-bold text-slate-900 mb-8 flex items-center gap-3">
                <Code2 className="w-6 h-6 text-purple-600" /> Technical Capabilities
              </h3>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  ...
                  <div key={idx} className="group p-6 bg-white rounded-2xl border border-gray-100 hover:border-purple-200 hover:shadow-xl hover:shadow-purple-900/5 transition-all">
            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div>
                <h3 className="text-2xl font-bold text-slate-900 mb-8 flex items-center gap-3">
                  <LineChart className="w-6 h-6 text-fuchsia-600" /> Digital & Growth
                </h3>
                <div className="space-y-4">
                  {[
                    ...
                    <div key={idx} className="flex gap-4 items-start p-4 bg-white rounded-xl border border-gray-100">
              ...
              <div>
                <h3 className="text-2xl font-bold text-slate-900 mb-8 flex items-center gap-3">
                  <Sparkles className="w-6 h-6 text-pink-500" /> Creative Services
                </h3>
                <div className="space-y-4">
                  {[
      ...
      <section id="portfolio" className="py-20 bg-slate-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Client Portfolio</h2>
            <div className="w-20 h-1.5 bg-gradient-to-r from-purple-500 to-fuchsia-500 mx-auto rounded-full"></div>
          </div>

          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h3 className="text-xl font-bold mb-6 text-purple-300 border-b border-slate-700 pb-2">Technology Clients</h3>
              <ul className="space-y-4">
                {[
                  ...
                  <li key={i} className="bg-slate-800/50 p-4 rounded-xl border border-slate-700">
                    <div className="flex justify-between items-start mb-1">
                      <span className="font-bold text-white">{c.name}</span>
                      <span className="text-xs px-2 py-1 bg-slate-700 rounded text-slate-300">{c.ind}</span>
                    </div>
                    <div className="text-sm text-slate-400">{c.svc}</div>
                  </li>
                ))}
              </ul>
            </div>
            ...
            <div>
              <h3 className="text-xl font-bold mb-6 text-fuchsia-300 border-b border-slate-700 pb-2">Non-Technical Clients</h3>
              <ul className="space-y-4">
                {[
                  ...
                  <li key={i} className="bg-slate-800/50 p-4 rounded-xl border border-slate-700">
                    <div className="flex justify-between items-start mb-1">
                      <span className="font-bold text-white">{c.name}</span>
                      <span className="text-xs px-2 py-1 bg-slate-700 rounded text-slate-300 flex items-center gap-1"><MapPin className="w-3 h-3"/> {c.loc}</span>
                    </div>
                    <div className="text-sm text-slate-400">{c.svc}</div>
                  </li>
                ))}
      ...
      <section className="py-20 bg-white border-y border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-16">
            <div>
              <h3 className="text-3xl font-bold text-slate-900 mb-6">Why Triverse Solutions?</h3>
              ...
              <div className="space-y-4">
                {["End-to-End Service Delivery", "Dedicated Cross-Functional Teams", "Customized Business Solutions", "Agile Execution Methodology", "Scalable Technology Architecture", "Long-Term Client Partnerships", "Innovation-Driven Approach"].map((str, i) => (
                  <div key={i} className="flex items-center gap-3">
                    <div className="w-6 h-6 rounded-full bg-purple-100 flex items-center justify-center text-purple-600 shrink-0"><CheckCircle2 className="w-4 h-4" /></div>
            ...
            <div className="bg-slate-50 p-8 rounded-3xl border border-gray-100">
              <h3 className="text-2xl font-bold text-slate-900 mb-6 flex items-center gap-2"><Building2 className="w-6 h-6 text-purple-600"/> Organizational Structure</h3>
              <div className="space-y-6">
                <div className="p-4 bg-white rounded-xl border border-gray-100 shadow-sm">
                  <div className="flex justify-between items-end mb-2">
                    <h4 className="font-bold text-lg text-slate-800">Technical Division</h4>
                    <span className="text-purple-600 font-bold bg-purple-50 px-3 py-1 rounded-full text-sm">08 Members</span>
                  </div>
                  <p className="text-sm text-slate-500">Development, Deployment, Testing, Support, Automation</p>
                </div>
                <div className="p-4 bg-white rounded-xl border border-gray-100 shadow-sm">
                  <div className="flex justify-between items-end mb-2">
                    <h4 className="font-bold text-lg text-slate-800">Business & Creative Division</h4>
                    <span className="text-fuchsia-600 font-bold bg-fuchsia-50 px-3 py-1 rounded-full text-sm">06 Members</span>
                  </div>
                  <p className="text-sm text-slate-500">Marketing, Branding, Design, Customer Relations</p>
                </div>
                <div className="flex justify-between items-center p-4 bg-slate-900 rounded-xl text-white">
                  <span className="font-bold">Total Workforce</span>
                  <span className="font-bold text-lg">14 Members</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-12 mb-12">
            <div>
              ...
              <p className="text-sm font-semibold text-slate-700 bg-slate-50 inline-block px-3 py-1.5 rounded-lg border border-slate-100">
                UDYAM-MH-26-1089081
              </p>
            </div>
            ...
            <div>
              <h4 className="font-bold text-slate-900 mb-6">Industries Served</h4>
              <div className="flex flex-wrap gap-2">
                {["Healthcare", "Education", "Real Estate", "Retail & E-Commerce", "Travel", "Agencies", "Startups", "Hospitality", "Sports"].map((ind, i) => (
                  <span key={i} className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-full text-xs text-slate-600">
                    {ind}
                  </span>
                ))}
              </div>
          ...
          <div className="border-t border-gray-100 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-400">
            ...
            <a href="https://www.triversesolutions.in" target="_blank" rel="noopener noreferrer" className="hover:text-purple-600 transition-colors flex items-center gap-2 font-medium">
